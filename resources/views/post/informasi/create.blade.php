    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Tambah Informasi</h2>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow">
                    <div class="card-body">
                        <form id="jquery-val-form" class="forms-sample" action="{{ route('informasi.store') }}" method="post" enctype="multipart/form-data" id="forminformasi">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <div class="col-sm-12">
                                      <h4 class="mb-2 text-lg-left text-center text-primary"><b>Data Informasi</b></h4>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea name="isi" id="content-textarea" type="textarea" style="display: none"></textarea>
                                    </div>
                                </div>
