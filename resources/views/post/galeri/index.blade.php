    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Galeri</h2>
                    ...
                    <div class="card-header border-bottom">
                        <div class="dt-action-buttons">
                            <div class="dt-buttons d-flex-row">
                                <a href="{{route('galeri.create')}}" class="btn btn-primary"><i data-feather="plus"></i> Tambah Galeri</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <table class="table table-bordered" id="tabelgaleri">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#tabelgaleri tbody').on('click','.btnhapus', function(){
                ...
                var data = row.data()
                if( !confirm('Lanjutkan proses hapus data galeri "'+data.judul+'"?')){
